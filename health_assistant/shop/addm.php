...
if(isset($addm))
{
	...
	if($r=='on')
		...
		$r=1;
	$q="insert into product(name,price,sid,s_des,cid,status,expdate,m_photo,ip_up,r_marko) values('$name',$price,$id1,'$desc',$category,0,'$expdate','$photo','$ph',$r)";
		if(mysqli_query($conn,$q))
			echo "<script>alert('Ragistared');</script>	";
		else
			echo "<script>alert(' not Ragistared');</script>	";
}
?>
<body >
	<head>
...
<form method="get">
<table  bgcolor="white" style="padding:10px; border-radius:40px;"align="center" cellpadding="5" cellspacing="10">
	<tr align="center">
		<th colspan="2">
			<h1>Add Medicine
		</th>
