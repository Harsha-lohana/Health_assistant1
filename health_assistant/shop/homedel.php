...
<!---body----->
	<div class="c">
	<div class="row" style="background-image:url(../a1.png);background-size:1070px 500px; box-shadow: 0 0 13px 0px rgba(0,0,0,0.1); border-radius:30px">
		<div class="c-1">
			<h1>Let's Recover Fast!</h1>
			<p>Let's Get fast medicine to you !<br> with nearest availability of needed medicine  </p>
			<br>
			<input class="btnfind" onclick="fun()" type="button" value="Let's Find" style=""/>
		</div>
		<div class="c-1">
